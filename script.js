...
function showQuote() {
  ...
  quote.textContent = "Content: " + randomQuote.quote;
...
function showRiddle() {
  ...
  question.textContent = "Question: " + randomRiddle.question;
  answer.textContent = "Answer: " + randomRiddle.answer;
...
function revealAnswers() {
  ...
  if (riddle && riddleAnswer.hidden){
    ...
    alert("The riddle anwswer is already exposed!");
  } else{
    alert("There is no riddle to show answer"); 
  }
}
